      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 flex-col justify-between p-12">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="text-white text-2xl font-bold tracking-tight">mohallaMitr</span>
          </div>
          <div className="mt-16">
            ...
            <p className="mt-4 text-indigo-200 text-lg">
              One dashboard to oversee societies, businesses, and users across the mohallaMitr platform.
            </p>
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          <div className="lg:hidden mb-8 text-center">
            <div className="inline-flex items-center gap-2 mb-2">
              ...
              <span className="text-gray-900 text-xl font-bold">mohallaMitr</span>
            </div>
          </div>
            ...
            <form onSubmit={handleLogin} className="mt-6 space-y-5">
              <div>
                ...
                <input
                  ...
                  placeholder="admin@mohallamitr.in"
